...
// This export exists only in the local-test Worker main. src/worker.ts never
// exports the compatibility entrypoint into a managed deployment.
export { LocalLegacyRuntimeEntrypoint } from "../src/huddles_runtime.js";
...
export default {
  async fetch(request: Request, env: Env): Promise<Response> {
    ...
    if ((path !== "/ensure" && path !== "/invoke") || !env.PillboxRuntime) {
